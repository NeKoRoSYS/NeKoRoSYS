...
- [NeKoROBOT.js](https://github.com/NeKoRoSYS/NeKoROBOT.js) is aa full-stack plug-n-play Discord.js bot written in Typescript and Python for its frontend and backend, respectively. It does not provide a MongoDB account but it is built to connect and interface with a MongoDB database.
  ...
  <table width="100%">
    <tr>
      <td align="center" valign="top" width="33%">
        ...
        <a href="https://www.adobe.com/products/photoshop-lightroom.html" target="_blank"><img style="margin: 5px" src="https://profilinator.rishav.dev/skills-assets/lightroom.png" alt="Lightroom" height="50"/></a>  
        <a href="https://www.blender.org/" target="_blank"><img style="margin: 5px" src="https://profilinator.rishav.dev/skills-assets/blender_community_badge_white.svg" alt="Blender" height="50"/></a>  
      </td>
